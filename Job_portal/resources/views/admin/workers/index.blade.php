...
@section('admin.content')
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title" style="color:rgb(0, 138, 202);font-size:25px; text-align:center;">All
                    Workers</h4>
                        ...
                        @foreach ($workers as $worker)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <div class="p-2">
                                            <a href="{{ url('/edit-workers/' . $worker->id) }}"
                                               class=" btn btn-info btn-sm"> <i class="las la-edit"></i></a>
                                        </div>
                                        <div class="p-2">
                                            <form action="{{ url('/delete-workers/' . $worker->id) }}"
                                                  method="post">
                                                @csrf
                                                @method('delete')
